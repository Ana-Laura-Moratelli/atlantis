...
var MenuAtualizarDependente = /** @class */ (function () {
    function MenuAtualizarDependente() {
    }
    MenuAtualizarDependente.prototype.mostrar = function () {
        console.clear();
        console.log("****************************");
    ...
    return MenuAtualizarDependente;
}());
exports.default = MenuAtualizarDependente;
