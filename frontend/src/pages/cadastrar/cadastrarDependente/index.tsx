...
function CadastrarDependente() {
    ...
    const [titulares, setTitulares] = useState<{ id: number; nome: string }[]>([]);
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/cadastrar-dependente', data);
            Swal.fire({
                icon: 'success',
                ...
                confirmButtonColor: '#3871C1',
                customClass: {
                    confirmButton: 'bg-blue-600 text-white hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg',
                },
            });
            setTitularId('');
            setNome('');
            ...
            setDocumentos([{ tipo: '', numero: '', dataExpedicao: '' }]);
        } catch (error) {
            ...
            if (axios.isAxiosError(error)) {
                ...
                if (status === 400 && data?.message === 'Não é possível cadastrar. Documentos duplicados encontrados.') {
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <p>Não é possível cadastrar. Os seguintes documentos já estão cadastrados:</p>
                            <ul>
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Erro',
                        text: 'Erro ao cadastrar dependente.',
                        confirmButtonText: 'OK',
                        confirmButtonColor: '#3871C1',
                    });
                }
    ...
    return (
        <>
            <NavBar />
            <h1 className="text-center text-3xl font-bold pt-4 pb-4">Cadastro de Dependente</h1>
