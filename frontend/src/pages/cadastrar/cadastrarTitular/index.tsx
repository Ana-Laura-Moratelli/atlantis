...
function CadastrarTitular() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/cadastrar-titular', data);
            Swal.fire({
                icon: 'success',
            ...
            if (axios.isAxiosError(error)) {
                ...
                if (status === 400 && data?.message === 'Não é possível cadastrar. Documentos duplicados encontrados.') {
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <p>Não é possível cadastrar. O documento já está cadastrado:</p>
                            <ul>
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Erro',
                        text: 'Erro ao cadastrar titular.',
                        confirmButtonText: 'OK',
                        confirmButtonColor: '#3871C1',
                    });
                }
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Erro',
                    text: 'Erro inesperado ao cadastrar titular.',
                    confirmButtonText: 'OK',
                    confirmButtonColor: '#3871C1',
                });
            }
    ...
    return (
        <>
            <NavBar />
            <h1 className="text-center text-3xl font-bold pt-4 pb-4">Cadastro de Titular</h1>
